	...
	class IndexController extends ControllerBase
	{
		...
		public function indexAction()
		{
			...
			if($content === null)
			{
				...
				$newProducts = $this->productsModel->getNewProducts($this->_shop->price_id, 10, false);
				$this->view->setVar("latestProducts", $newProducts);

				$topProducts = $this->productsModel->getTopProducts($this->_shop->price_id, 5, false);
				$this->view->setVar("topProducts", $topProducts);

				$featuredProducts = $this->productsModel->get(array(), array('date_create' => 'DESC'), 2);
